...
VALUES
    ...
    (
        ...
        '[
            ...
            {"title": "Customized Security", "description": "Tailored security protocols to match your organization's specific requirements."}
        ]'::jsonb,
        '[
    ...
    (
        ...
        '[
            ...
            {"title": "Review & Adjust", "description": "Regular assessment of prediction accuracy and model refinement."}
        ]'::jsonb,
        '{1, 2}'
    ),
    (
    ...
    (
        ...
        '[
            {"title": "Discovery & Planning", "description": "Collaborative planning to define project scope and requirements."},
            {"title": "Design & Prototyping", "description": "Creating wireframes and designs that align with your brand identity."},
            {"title": "Development", "description": "Building your website using cutting-edge technologies and best practices."},
            {"title": "Testing & Deployment", "description": "Rigorous testing and seamless deployment to ensure reliability."}
        ]'::jsonb,
        '{7, 8}'
    ),
    (
    ...
    (
        ...
        '[
            ...
            {"title": "Integration & Testing", "description": "Connecting payment gateways and ensuring secure transactions."}
        ]'::jsonb,
        '{6, 7}'
    );
